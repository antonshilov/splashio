object Versions {
  ...
  const val versions_plugin = "0.20.0"
  const val support = "28.0.0-rc02"
  const val quality_tools_plugin = "0.13.0"
  ...
  const val mockito = "2.0.0-alpha03"
...
object Deps {
  ...
  const val recyclerview_v7 = "androidx.recyclerview:recyclerview:1.0.0"
